document.addEventListener('DOMContentLoaded', function() {
    ...
    togglePasswordButton.addEventListener('click', function() {
        ...
        togglePasswordButton.innerHTML = `<img src="../assets/${isPasswordType ? 'eye' : 'eye-slash'}-icon.svg" alt="">`;
    });
    ...
    toggleKonfirmasiButton.addEventListener('click', function() {
        ...
        // Ganti gambar mata sesuai dengan status sebelumnya
        toggleKonfirmasiButton.innerHTML = `<img src="../assets/${isPasswordType ? 'eye' : 'eye-slash'}-icon.svg" alt="">`;
    });
});